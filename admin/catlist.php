                ...
                <div class="block">      
					...
					<tbody>
						...
						<tr class="odd gradeX">
							...
							<td><a class="btn btn-blue" href="editcat.php?cateditid=<?php echo $result['catId']; ?>">Edit</a>  <a class="btn btn-red" onclick="return confirm('Are you sure to Delete ?');" href="?catdelid=<?php echo $result['catId']; ?>">Delete</a></td>
						</tr>
					<?php 	}}else {
